...
**Last Updated:** 2026-03-21 (Session 3 완료)
...
│   ├── components/ (AdSlot, FAQ, CitySearch, StickyHeader, etc.)
...
2. ⏳ 3일 대기 → Search Console 데이터 수집
3. Phase 1: CTR 최적화 (노출 있고 CTR < 2% 페이지)
4. Phase 1: 순위 10~20위 페이지 내부링크/콘텐츠 보강
